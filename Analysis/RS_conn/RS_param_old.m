function [n] = RS_param(comp,subj,drive)

n.comp = comp; n.drive = drive;
n.rootdir = ['/Users/' comp '/Google_Drive/PhD/MMASS/Experiment/'];
n.homedir = [n.rootdir 'Analysis/RS_conn/']; n.bhvdir = [n.rootdir 'Behavioral'];
...
delta      = 1:4; theta = 4:8; alpha = 8:13; beta = 13:30; gamma = 30:80; bb = 1:80;
n.band     = {delta, theta, alpha, beta, gamma, bb}; 
n.nband= numel(n.band);
n.bandname = {'delta','theta','alpha','beta','gamma','bb'}; 
n.bandfreq = {1:4, 4:8, 8:13, 13:30, 30:80, 1:80}; 
n.nf = 80;
n.subj     = length(subj); % number of independent subjects
n.bhv_vars = {'offline', 'online', 'mean'};
...
n.colors   = colors; n.colors_onesided = colors_onesided;
