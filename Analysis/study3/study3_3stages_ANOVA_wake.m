...
anova_dir = [v.homedir filesep 'results/ANOVA/interstage_wake/'  ];
    ...
    for b = 1:v.nbands
        for w=1:v.nnetws
            for ww=1:v.nnetws
                ...
                vect3 = squeeze(NETW(w,ww,:,4,2,c,b));
            ...
            for w=1:v.nnetws
                for ww=1:v.nnetws
                    if ANOVA_p(w,ww,c,b) <0.05 == 1
                        ...
                        x = [squeeze(NETW(w,ww,:,4,2,c,b)); squeeze(NETW(w,ww,:,1,2,c,b)); squeeze(NETW(w,ww,:,2,2,c,b)) ];
                        y = [repmat({'RS'}, v.nsubj,1);repmat({'NREM2'}, v.nsubj,1) ; repmat({'NREM3'}, v.nsubj,1)];
                        grouporder={ 'RS', 'NREM2', 'NREM3'};
