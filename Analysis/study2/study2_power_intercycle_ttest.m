function study2_power_intercycle_ttest(v)
...
savepath = [v.homedir '/results/power/intercycle/'];
...
for b = 1:v.nbands
    for st= v.stage
        for c = v.cycle
            for nt = 1:v.nnetws
                if c == 1; cyc1 = 1; cyc2 = 2;
                elseif c == 2; cyc1 = 2; cyc2 = 3;
                elseif c == 3; cyc1 = 1; cyc2 = 3;
                end
                r1 = squeeze(PSD(nt,b,:,st,cyc1));
                r2 = squeeze(PSD(nt,b,:,st,cyc2));
...
for st= v.stage
    for c = v.cycle
        if c == 1; comp = 'c1_vs_c2'; comp_t1 = 'Cycle 1' ; comp_t2 = 'Cycle 2' ;
        elseif c == 2; comp = 'c2_vs_c3'; comp_t1 = 'Cycle 2' ; comp_t2 = 'Cycle 3' ;
        elseif c == 3; comp = 'c1_vs_c3'; comp_t1 = 'Cycle 1' ; comp_t2 = 'Cycle 3' ;
        end
        ...
        title({[v.stages{st} ' ' comp_t1 ' x ' comp_t2 ] [' Power t-test, n= ' num2str(v.nsubj) ]});
        ...
        save_name = [savepath  v.stages{st} '_' comp '_power_n' num2str(v.nsubj) '.png'];
